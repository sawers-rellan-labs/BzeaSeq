---
title: "Maize Genome Ancestry Analysis with Adjustable Bin Size"
...
#     geom_tile() +
#     scale_fill_manual(values = pal) +
#     labs(title = title, x = "Chr 10 Position (bp)", fill = "Genotype") +
#     theme_minimal() +
#     theme(
...
# create_tile(read_freq, "K", paste("ALT_FREQ (", BIN_SIZE_LABEL, " bins)"," Sample PN17_SID1632", sep=""))
```

### 3. Combined visualization of all methods
, fig.height=12
```{r tile-plots, fig.height=8}
